...
This repository contains the TSAR synthetic task, minimal model, and training/repro code for the paper "Separate and Amplify: Attention's Geometry of Retrieval". DOI: `10.5281/zenodo.19359748`.
